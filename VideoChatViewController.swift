...
class VideoChatViewController: UIViewController {
    ...
    let retryMessage = "エラーが発生しました。通信環境をお確かめの上、再度入室し直してください。"
    ...
    func handleError(message: String){
        ...
        let alert: UIAlertController = UIAlertController(title: "エラー", message: self.retryMessage, preferredStyle:  UIAlertControllerStyle.alert)
